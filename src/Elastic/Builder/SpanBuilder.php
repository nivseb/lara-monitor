...
class SpanBuilder implements SpanBuilderContract
{
    ...
    protected function buildSpanRecordBase(AbstractSpan $span, int $transactionStart): ?array
    {
        ...
        return [
            ...
            'duration'    => (int) ($duration / CarbonInterface::MICROSECONDS_PER_MILLISECOND),
            'start'       => (int) (($span->startAt - $transactionStart) / CarbonInterface::MICROSECONDS_PER_MILLISECOND),
            'type'        => $typeData->type,
